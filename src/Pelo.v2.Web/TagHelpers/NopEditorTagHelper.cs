...
namespace Pelo.v2.Web.TagHelpers
{
    ...
    public class NopEditorTagHelper : TagHelper
    {
                                     ...
                                     TagHelperOutput output)
        {
            ...
            bool.TryParse(RenderFormControlClass,
                          out bool renderFormControlClass);
            ...
            var viewEngine = CommonHelpers.GetPrivateFieldValue(_htmlHelper,
                                                                "_viewEngine") as IViewEngine;
            var bufferScope = CommonHelpers.GetPrivateFieldValue(_htmlHelper,
                                                                 "_bufferScope") as IViewBufferScope;
            var templateBuilder = new TemplateBuilder(viewEngine,
                                                      bufferScope,
