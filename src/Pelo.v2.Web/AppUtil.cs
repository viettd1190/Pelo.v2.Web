...
namespace Pelo.v2.Web
{
    ...
    {
        public static string DATE_TIME_FORMAT = "{0:dd-MM-yyyy hh:mm}";
        ...
        public static string NumberToTextVn(decimal total)
        {
            try
            {
                ...
                for (int i = 0; i < len; i++)
                {
                    n[len - 1 - i] = Convert.ToInt32(nstr.Substring(i,
                                                                    1));
                }
                ...
                for (int i = len - 1; i >= 0; i--)
                {
                    if(i % 3 == 2) // số 0 ở hàng trăm
                    {
                        if(n[i] == 0
                           && n[i - 1] == 0
                           && n[i - 2] == 0) continue; //nếu cả 3 số là 0 thì bỏ qua không đọc
                    }
